...
public class MbsAdsSdkSampleActivity extends FragmentActivity implements ActionBar.TabListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mViewPagerAdapter = new MbsFragmentPagerAdapter(getSupportFragmentManager());
